    ...
    <React.Fragment>
      <PageHeader>
        <Flex className="pf-v6-u-flex-nowrap">
          ...
          />
          <FlexItem className="pf-v6-u-align-self-flex-start">
            <PageHeaderTitle title="Notifications" className="pf-v6-u-mb-sm" />
      ...
      <Main>
            ...
            <Card className="pf-v6-u-mb-lg">
              <Grid hasGutter>
                ...
                <GridItem
                  md={6}
                  lg={4}
                  className="pf-v6-u-display-none pf-v6-u-display-block-on-md pf-v6-c-card__cover-image"
                ></GridItem>
              </Grid>
            </Card>
          </React.Fragment>
        ...
        {isOrgAdmin ? (
          <React.Fragment>
            ...
            <DataList aria-label="Supporting features list" className="pf-v6-u-mb-lg">
              <CustomDataListItem
                icon={IconName.USER}
                isExpanded
