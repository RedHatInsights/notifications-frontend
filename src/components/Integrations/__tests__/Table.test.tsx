/* eslint-disable @typescript-eslint/no-non-null-assertion, testing-library/no-node-access, testing-library/prefer-screen-queries */
...
describe('components/Integrations/Table', () => {
  ...
  it(
    'Last connection attempt show last attempt status with degraded connection if there is at least one success and at ' +
  ...
  it(
    'Last connection attempt show last attempt status with degraded connection if there is at least one success ' +
  ...
  it('Clicking Details arrow calls onCollapse with the integration, index and opposite of isOpen', async () => {
    ...
    await userEvent.click(screen.getByLabelText('Details'));
