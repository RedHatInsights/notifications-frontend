...
export const IntegrationHttpSchema: Yup.SchemaOf<NewIntegrationTemplate<IntegrationHttp>> =
...
export const IntegrationAnsibleSchema: Yup.SchemaOf<NewIntegrationTemplate<IntegrationAnsible>> =
  IntegrationSchemaBase.concat(
    Yup.object().shape({
...
export const IntegrationCamelSchema: Yup.SchemaOf<NewIntegrationTemplate<IntegrationCamel>> =
  IntegrationSchemaBase.concat(
    Yup.object().shape({
