...
describe('src/utils/OuiaSelector', () => {
    ...
    describe('ouiaSelectors.getByOuia', () => {
        ...
        it('Allows chaining calls', () => {
            ...
            .getByOuia('my-component', 'c1')
            .getByOuia('foobar');
            const result2 = ouiaSelectors
            .getByOuia('my-component', 'c2')
            .getAllByOuia('foobar');
    ...
    describe('ouiaSelectors.queryByOuia', () => {
    ...
    describe('ouiaSelectors.getAllByOuia', () => {
        it('Throws if nothing is found', () => {
            render(<></>);
    ...
    describe('ouiaSelectors.queryAllByOuia', () => {
